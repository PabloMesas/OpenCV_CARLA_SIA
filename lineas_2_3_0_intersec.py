...
pointR = righLines[0]
a = np.cos(pointR[1]) #pendiente
b = np.sin(pointR[1]) #pendiente
x0 = a*pointR[0] #desplazamiento en X
y0 = b*pointR[0] #desplazamiento en Y
x1 = int(x0 + 1000*(-b))
y1 = int(y0 + 1000*(a))
x2 = int(x0 - 1000*(-b))
y2 = int(y0 - 1000*(a))
...
pointL = leftLines[0]
a = np.cos(pointL[1]) #pendiente
b = np.sin(pointL[1]) #pendiente
x0 = a*pointL[0] #desplazamiento en X
y0 = b*pointL[0] #desplazamiento en Y
x1 = int(x0 + 1000*(-b))
y1 = int(y0 + 1000*(a))
x2 = int(x0 - 1000*(-b))
y2 = int(y0 - 1000*(a))
...
#####################Pintar Iterseccion de dos puntos###########
