...
for line in lines:
    for rho,theta in line:
        ...
        if theta*(180/np.pi) < 80 and theta*(180/np.pi) > 1 or theta*(180/np.pi) >100 and theta*(180/np.pi) < 170:
...
cv2.line(edges,(int(height/2),int(width/2)),(int(height/2),int(width/2)),(255,255,0),4) # Punto medio
